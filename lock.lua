...
local Window = library:AddWindow("morgueware", {
...
local Aiming = loadstring(game:HttpGet("https://raw.githubusercontent.com/untestedd/90v6843/main/omgyes.lua"))()
local ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/untestedd/7v5832n53/main/89v5n789b6534.txt"))()
ESP:Toggle(false)
ESP.Tracers = false
ESP.Names = false
ESP.Boxes = false
...
CreditTAB:AddButton("Scripted by grave#0666", function(bool)
    setclipboard("grave#0666 :D")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
